...
public class JSONParser1
{
  ...
  public BigDecimal parseNum(BufferedReader str)
    throws Exception
  {
  ...
  public Object parseNull(BufferedReader str)
    throws Exception
  {
  ...
  public boolean parseTrue(BufferedReader str)
    throws Exception
  {
  ...
  public boolean parseFalse(BufferedReader str)
    throws Exception
  {
  ...
  public String parseString(BufferedReader str)
  {
    // TODO Auto-generated method stub
    return null;
  }

  public Vector<Object> parseArray(BufferedReader str)
    throws Exception
  {
  ...
  public HashMap<String, Object> parseObject(BufferedReader str)
    throws Exception
  {
